...
SXS_num = sys.argv[1]
mode_search_complete = ModeSearchAllFreeVaryingNSXSAllRelevant(SXS_num, N_list = [8, 10], 
                                                              load_pickle = False
                                                              )
...
predicted_qnm_list = []
plot_relevant_mode_search_full(mode_search_complete, predicted_qnm_list = predicted_qnm_list, postfix_string="run2")
